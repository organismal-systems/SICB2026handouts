...
The *DiatomSizeESS* model outputs two tables of results, and two sets of plots:

## Tabular results
Tabular results are shown in the noteboook cell under the **Run simulation** button, and also saved in the text files [](standingstocks.txt)Setting up the DiatomESS model on Binder requires two steps:
